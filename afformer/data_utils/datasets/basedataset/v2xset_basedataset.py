from afformer.data_utils.datasets.basedataset.opv2v_basedataset import OPV2VBaseDataset

# All the same as OPV2V
class V2XSETBaseDataset(OPV2VBaseDataset):
    def __init__(self, params, visulize, train=True, mode=None):
        super().__init__(params, visulize, train, mode)

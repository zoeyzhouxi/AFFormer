...
class BasePostprocessor(object):
    ...
    def generate_object_center(self,
        ...
        if 'k_frames' in cav_contents[0]:
            for cav_content in cav_contents:
                tmp_object_dict.update(cav_content['k_frames'][0]['params']['vehicles'])
        else:
            for cav_content in cav_contents:
        ...
        filter_range = self.params['anchor_args']['cav_lidar_range'] \
            if self.train else self.params['anchor_args']['gt_range']
    ...
    def generate_object_center_dairv2x(self,
        ...
        tmp_object_list = cav_content['k_frames'][0]['params']['vehicles'] #世界坐标系下
    ...
    def generate_object_corner_dairv2x(self,
                               cav_contents,
                               reference_lidar_pose):
        """
        Retrieve all objects in a format of (n, 7), where 7 represents
        ...
        tmp_object_list = []
        cav_content = cav_contents[0]
        tmp_object_list = cav_content['k_frames'][0]['params']['vehicles']
            
        output_dict = {}
        filter_range = self.params['anchor_args']['cav_lidar_range']

        box_utils.project_world_objects_corner_dairv2x(tmp_object_list,
                                        output_dict,
                                        reference_lidar_pose,
                                        filter_range,
                                        self.params['order'])

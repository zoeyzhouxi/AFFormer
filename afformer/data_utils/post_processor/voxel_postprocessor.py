...
from afformer.data_utils.post_processor.base_postprocessor \
    import BasePostprocessor
from afformer.utils import box_utils
from afformer.utils.box_overlaps import bbox_overlaps
from afformer.visualization import vis_utils
from afformer.utils.common_utils import limit_period
...
class VoxelPostprocessor(BasePostprocessor):
    ...
    def post_process(self, data_dict, output_dict):
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            if 'rm' in output_dict or 'rm' in output_dict[cav_id]:
                output_dict[cav_id]['reg_preds'] = output_dict[cav_id]['rm']
            if 'dm' in output_dict or 'dm' in output_dict[cav_id]:

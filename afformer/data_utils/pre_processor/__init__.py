...
from afformer.data_utils.pre_processor.base_preprocessor import BasePreprocessor
from afformer.data_utils.pre_processor.voxel_preprocessor import VoxelPreprocessor
from afformer.data_utils.pre_processor.bev_preprocessor import BevPreprocessor
from afformer.data_utils.pre_processor.sp_voxel_preprocessor import SpVoxelPreprocessor
...
def build_preprocessor(preprocess_cfg, train):
    ...
    error_message = f"{process_method_name} is not found. " \
                     f"Please add your processor file's name in afformer/" \

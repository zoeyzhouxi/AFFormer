...
from afformer.data_utils.post_processor.voxel_postprocessor import VoxelPostprocessor
...
class PointPillarLoss(nn.Module):
    def __init__(self, args):
        ...
        if 'iou' in args:
            from afformer.pcdet_utils.iou3d_nms.iou3d_nms_utils import aligned_boxes_iou3d_gpu

...
class PointPillarMultiscale(nn.Module):
    def __init__(self, args):
        super(PointPillarMultiscale, self).__init__()
    ...
    def forward(self, data_dict):
        ...
        voxel_features = data_dict['processed_lidar'][0]['voxel_features']
        voxel_coords = data_dict['processed_lidar'][0]['voxel_coords']
        voxel_num_points = data_dict['processed_lidar'][0]['voxel_num_points']

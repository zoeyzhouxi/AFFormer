...
import afformer.utils.common_utils as common_utils
from afformer.utils.transformation_utils import x1_to_x2, x_to_world
...
def project_world_objects_corner_dairv2x(object_list,
                          output_dict,
                          lidar_pose,
                          lidar_range,
                          order):
